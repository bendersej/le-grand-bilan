...
- prefectures-regions.gouv.fr and departmental préfecture sites (e.g. guadeloupe.gouv.fr) mirror Matignon discours and dossiers de presse as curl-fetchable pages/PDFs: the reliable official anchor when the canonical page lives on 403'd info.gouv.fr or captcha-walled sante.gouv.fr. cor-retraites.fr hosts official reports remis au Premier ministre as plain PDFs; lecese.fr and justice.gouv.fr are curl-fetchable and anchor CESE/Chancellerie events.
