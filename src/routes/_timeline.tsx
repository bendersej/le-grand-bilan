...
export const Route = createFileRoute('/_timeline')({ component: TimelineLayout })

// The timeline is the app: child routes (decision, politician,
// category, about) render as modals in the Outlet, above the always-visible
// timeline, so its scroll position survives navigation.
